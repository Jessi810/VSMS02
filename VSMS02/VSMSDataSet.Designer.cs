...
namespace VSMS02 {
    ...
    public partial class VSMSDataSet : global::System.Data.DataSet {
        ...
        public partial class PatientDataTable : global::System.Data.TypedTableBase<PatientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PatientRow AddPatientRow(int Id, string FirstName, string LastName) {
...
namespace VSMS02.VSMSDataSetTableAdapters {
    ...
    public partial class PatientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Patient] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Orig" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Patient] ([Id], [FirstName], [LastName]) VALUES (@Id, @FirstNa" +
                "me, @LastName);\r\nSELECT Id, FirstName, LastName FROM Patient WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patient] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName));
SELECT Id, FirstName, LastName FROM Patient WHERE (Id = @Id)";
        ...
        public virtual int Fill(VSMSDataSet.PatientDataTable dataTable) {
        ...
        public virtual VSMSDataSet.PatientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            VSMSDataSet.PatientDataTable dataTable = new VSMSDataSet.PatientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(VSMSDataSet.PatientDataTable dataTable) {
